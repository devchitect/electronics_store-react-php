<?php
    ...
    class Phone extends Database_Connection {
        public $data = null;
        ...
        function addNewPhone( $id, $ram, $storage, $color, $prototype, $images, $overview,
                                $name, $brand_id, $stock, $buy_price, $original_price, $category_id = 2){
            $result = true;
        ...
        function updatePhone( $id, $ram, $storage, $color, $prototype, $images, $overview,
            $name, $brand_id, $stock, $buy_price, $original_price, $category_id = 2){
            $result = true;
            ...
            $add_product = "UPDATE product SET name = ?, category_id = ?, brand_id = ?, stock = ?, buy_price = ?, original_price = ?, overview_image =? WHERE product_id = ?";
        ...
        function getAllPhoneJoinBrandonSpecificBrand($brand_id){
            $sql = 'SELECT p.product_id as id, p.name as name, b.name as brand, p.stock, p.buy_price, p.original_price, p.views, p.sales,  p.overview_image,
                    st.ram, st.storage, st.color
                    FROM product as p
                    JOIN brand as b ON p.brand_id = b.id
        ...
        function getPhoneWithIDnBrand($id,$brand_id = null){
